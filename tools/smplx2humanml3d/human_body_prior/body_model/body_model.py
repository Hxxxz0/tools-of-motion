...
class BodyModel(nn.Module):
    ...
    def __init__(self,
        ...
        self.model_type = {69: 'smpl', 153: 'smplh', 162: 'smplh', 45: 'mano', 105: 'animal_horse', 102: 'animal_dog', }[njoints]
    ...
    def forward(self, root_orient=None, pose_body=None, pose_hand=None, pose_jaw=None, pose_eye=None, betas=None,
        ...
        if self.model_type in ['smplh', 'smpl']:
            ...
            print('root_orient', root_orient.shape,'pose_body',pose_body.shape,'pose_hand',pose_hand.shape)
        elif self.model_type == 'smplx':
            full_pose = torch.cat([root_orient, pose_body, pose_jaw, pose_eye, pose_hand], dim=-1)
            #print('root_orient', root_orient.shape,'pose_body',pose_body.shape,'pose_hand',pose_hand.shape)  # orient:3, body:63, jaw:3, eyel:3, eyer:3, handl, handr
        elif self.model_type in ['mano', ]:
        ...
        print('shape_components',shape_components.shape,'shapedirs',shapedirs.shape,'full_pose',len(full_pose),'v_template',v_template.shape,'self.posedirs',len(self.posedirs))
