import os 
import sys
os.chdir('/home/user/dxc/motion/momask-codes-main')
sys.path.append('/home/user/dxc/motion/momask-codes-main')
...
if __name__ == "__main__":
    ...
    folder = '/home/user/dxc/motion/momask-codes-main/vis/stable_base'
    ...
    for f in tqdm(files):
        ...
        converter.convert(joints, os.path.join(folder, 'ik_animations', f'ik_{f}'.replace('npy', 'bvh')), foot_ik=False)
